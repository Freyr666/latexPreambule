...
\usepackage{xltxtra}
%%Setting fonts
%fc-list to grep fonts
%fc-list :lang=ru for russian fonts
\setmainfont[Mapping=tex-text, Ligatures={Common, Rare, Historical}]{Carlito-Regular}
\usepackage{polyglossia}
\setmainlanguage{russian}
%\newfontfamily\russianfont{OpenGost Type A TT}
%%%%%
